    ...
    (function(){
        ...
        var tool = {
            ...
            MergeObject:function(obj1,obj2){
                ...
                for(var i=0,len=key2.length;i<len;i++){
                    if(Object.hasOwnProperty.call(obj1,key2[i])){
                        if(obj2[key2[i]] !== undefined){
        ...
        var tempObj ={
            ...
            //同步get请求
            get_sync:function(url,data,success,error,timeout){
                var ajaxParam ={
                    type:"get",
                    url:url,
                    data:data,
            ...
            //同步post请求
            post_sync:function(url,data,success,error,timeout){
                var ajaxParam ={
                    type:"post",
                    url:url,
                    data:data,
            ...
            //跨域get请求
            get_cross:function(url,data,success,error,timeout){
                var ajaxParam ={
                    type:"get",
                    url:url,
                    data:data,
            ...
            //跨域post请求
            post_cross:function(url,data,success,error,timeout){
                var ajaxParam ={
                    type:"post",
                    url:url,
                    data:data,
